...
// console.log(pizzaPalace.checkPizza("Big Mike"));
...
// const b = new Car("BMW", "X5", 58900);
// console.log(b);

// const c = new Car("Nissan", "Murano", 31700);
// console.log(c);
...
// const b = new Car({ brand: "BMW", model: "X5", price: 58900 });
// console.log(b);

// const c = new Car({ brand: "Nissan", model: "Murano", price: 31700 });
// console.log(c);
